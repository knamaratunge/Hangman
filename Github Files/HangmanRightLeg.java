...
public class HangmanRightLeg extends JPanel {
   private int length;
   ...
   public HangmanRightLeg(int wordLength, ArrayList <FoundLetter> list, String level, Point points, int game){
      length = wordLength;
      if (list != null){
   ...
   public void paintComponent(Graphics g) {
      ...
      g.drawLine(125,137,155,120); // right arm
      g.drawLine(125,175,105,215); // left leg  
      g.drawLine(125,175,145,215); // right leg 
